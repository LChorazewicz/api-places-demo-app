            ...
            <div>
                <div className="row">
                    <div className="textAlignLeft col-md-12">
                        ...
                        <section style={{fontSize: '24px', textAlign: 'justify'}}>
                            ...
                            <Link to={'/register'} className={'bold-orange-link'} href={'/register'}> tutaj </Link>
                            ...
                            <Link to={'/register'} className={'bold-orange-link'}> tutaj </Link>
                            Aby zobaczyć jak wygląda PlacesWidget.
                        </section>

                        <br/><br/><br/><br/><br/>
                        <h5 className={'textAlignRight'}>Aplikacja stworzona przez firmę <a
